...
import { getAllStaff, deleteStaff, updateStaff } from "@/lib/redux/actions/staffActions";
...
export default function EmployeesGridComponent() {
  ...
  const handleDelete = (id: string) => {
    if (window.confirm("Are you sure you want to delete this staff?")) {
      dispatch(deleteStaff(id)); // Dispatch delete action
    }
  };
  ...
  const handleUpdate = () => {
    if (editData) {
      ...
      dispatch(updateStaff({ id: editData.id, data: payload })); // Dispatch update action
      setShowModal(false);
    }
  };
