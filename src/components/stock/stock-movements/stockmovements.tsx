      ...
      <div className="content">
        <div className="page-header d-flex justify-content-between align-items-center flex-wrap">
          <div>
           ...
           <Link href="/addstockmovement" className="btn btn-sm btn-primary">ADD STOCK MOVEMENT</Link>
        </div>
        ...
        <div className="card mb-4">
          <div className="card-body">
            <div className="row g-3">
              ...
              <div className="col-md-4">
                <label className="form-label">Filter by Reason</label>
                <select className="form-select">
