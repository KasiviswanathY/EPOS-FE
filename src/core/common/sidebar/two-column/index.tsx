                                ...
                                <div className="tab-pane fade" id="stock">
                                    <ul>
                                        ...
                                        <li>
                                         ...
                                         <li>
                                            <Link href={route.stockdisparencies}>
                                                <span>Stock Disparencies</span>
                                        ...
                                        <li>
                                            <Link href={route.customer}>
                                                <span>Customers</span>
                                                                                ...
                                                                                <li>
                                            <Link href={route.customerreports}>
                                                <span>Customer Reports</span>
                                            </Link>
                                        </li>
                                        <li>
                                            <Link href={route.invoicemessages}>
                                                <span>Invoice Messages</span>
                                            </Link>
                                        </li>
                                        <li>
